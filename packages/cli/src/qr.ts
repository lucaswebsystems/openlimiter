/* The QR encoder stays: the desktop pairing screen renders through apps/desktop/ui/qr.js, which imports this module from the mirrored CLI build. The LAN view that once used it is gone. */
/**
